...
### 0.1 Binding outcomes of this blueprint
...
### 0.2 Product principles inherited without reinterpretation
...
### 3.3 Labels not recommended for primary navigation
...
| Section | Immediate job | Source/owner | Update method | Deterministic intelligence | AI role | Interesting fact | Primary next action | Signed-in change | Affiliate | Ad tier | Expiry/stale |
|---|---|---|---|---|---|---|---|---|---|---|---|
| Utility strip | Current status | Results/jackpot/events | Event-driven | Priority/ranking | Short explanation only | Optional jackpot milestone | Open exact context | Personal match/reply | Conditional | 0 | Event expiry |
| Main header | Navigate/search | Product configuration | Release-managed | Context state | AI trigger | N/A | Search/Ask | Notifications/account | No | 0 | Versioned |
| Primary nav | Reach page families | IA owner | Release-managed | Active context | None | N/A | Selected destination | My items appear separately | No | 0 | Versioned |
| Context bar | Orient page | Canonical page object | Per request | Breadcrumb/context | Suggested question | Optional | Follow/open parent | Follow state | No | 0 | Page lifecycle |
| Search | Find/answer | Search/entity index | Continuous | Exact entity matching | Answer/handoff | N/A | Best result | Personal results | Purchase query only | 0 | Index freshness |
| AI entry | Try AI | AI product + page context | Dynamic | Context prompt rules | Core | Relevant suggested question | Open page/tool/action | Memory and saved context | Contextual | 0 | Page/event |
| Account | Personal continuity | Identity/account | Real time | badges/counts | Personal assistant link | N/A | My LotteryCorner | Full personal menu | Contextual | 0 | Real time |
| Footer | Trust/discovery | IA/policy owner | Release/editorial | N/A | AI policy link | N/A | Major support path | Account controls | Disclosure links | 0 | Policy lifecycle |
| Ad anchors | Revenue | Monetization | Config/real time | Page tier | None | N/A | Advertiser action | Frequency control | N/A | by page | Campaign |
| Affiliate bar | Buy eligibility | Commerce rules | Daily/event | Eligibility | Explanation | N/A | Qualified outbound | Saved-number continuity | Core | 1 | Verification threshold |
| Responsible play | Help/control | Safety owner | Policy-managed | Suppression rules | Restricted | N/A | Help/control | Marketing suppression | Prohibited | 0 | Policy lifecycle |
...
# PART XXIII — OPEN FOUNDER DECISIONS

## 153. Decisions to Approve or Adjust

1. Desktop labels: Results, States, Games, Jackpots, Tools, News, Community.
2. Persistent desktop AI button label: **Ask LotteryCorner AI**.
3. Mobile bottom navigation: Home, Results, My Numbers, Community, Ask AI.
4. Personal shell label: **My LotteryCorner**, with Insider inside it.
5. Use of provisional Brand Navy / Action Blue / AI Teal direction.
6. Whether the utility strip is enabled at launch.
7. Whether anonymous guest number sets persist only for session or longer on device.
8. Whether the public AI allowance is exactly one answer or a limited session.
9. Whether News and Blog remain separate visible destinations under News.
10. Whether a purchase CTA may be sticky on eligible game/jackpot pages.
11. Initial ad anchors enabled by page family.
12. Whether “Prefer LotteryCorner on Google” appears only in News or also in Insider onboarding.

---

# PART XXIV — BLUEPRINT ACCEPTANCE CRITERIA

This blueprint is ready to freeze when:

1. Primary desktop navigation is approved.
2. Mobile bottom navigation is approved.
3. Search and Ask behavior is approved.
4. Anonymous, signed-in and Insider shells are approved.
5. AI identity and first-answer behavior are approved.
6. The visual direction is accepted as the basis for page-family mockups.
7. The reusable section IDs and contracts are accepted.
8. Advertising anchors and conflict rules are accepted.
9. State-aware affiliate shell rules are accepted.
10. The Section Intelligence Matrix is accepted.
11. The content-operations ownership model is accepted.
12. The behind-the-screen contract is accepted.
13. WCAG 2.2 AA is accepted as the accessibility target.
14. The provided desktop and mobile reference mockups are approved or annotated for revision.
15. No page-family blueprint begins until this shared shell is frozen.
...
# APPENDIX C — FINAL BLUEPRINT STATEMENT
